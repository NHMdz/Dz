...
local redzlib = {
   ...
   ["Color Stroke"] = Color3.fromRGB(38, 38, 45),
   ["Color Theme"] = Color3.fromRGB(99, 102, 241),
   ["Color Text"] = Color3.fromRGB(240, 240, 245),
   ["Color Dark Text"] = Color3.fromRGB(165, 165, 175)
  },

  Dark = {
   ["Color Hub 1"] = ColorSequence.new({
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(32, 32, 36)),
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(40, 40, 46)),
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(32, 32, 36))
   }),
   ["Color Hub 2"] = Color3.fromRGB(38, 38, 44),
   ["Color Stroke"] = Color3.fromRGB(70, 70, 80),
   ["Color Theme"] = Color3.fromRGB(90, 170, 255),
   ["Color Text"] = Color3.fromRGB(245, 245, 248),
   ["Color Dark Text"] = Color3.fromRGB(185, 185, 195)
  },

  Purple = {
   ["Color Hub 1"] = ColorSequence.new({
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(28, 24, 36)),
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(36, 32, 48)),
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(28, 24, 36))
   }),
   ["Color Hub 2"] = Color3.fromRGB(32, 28, 42),
   ["Color Stroke"] = Color3.fromRGB(50, 45, 65),
   ["Color Theme"] = Color3.fromRGB(168, 85, 247),
   ["Color Text"] = Color3.fromRGB(242, 242, 246),
   ["Color Dark Text"] = Color3.fromRGB(175, 175, 185)
  }
 },
 Info = {
  Version = "1.1.0"
